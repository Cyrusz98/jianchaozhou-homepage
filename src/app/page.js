...
export default function Home() {
    return (
        <Main>
            ...
            Hi, my name is Cyrus, and this is my welcome page. On this page you can find my media platform, my insights and past experiences. Hope you enjoy my website!"
            </span>
